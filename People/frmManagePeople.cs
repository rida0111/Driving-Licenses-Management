...
namespace DVLD2.People
{
    public partial class frmManagePeople : Form
    {
        ...
        private void LbFilter_TextChanged(object sender, EventArgs e)
        {
            string ColumnName = "";
            ...
            if (LbFilter.Text == "" || ColumnName == "None")
                _dtPeople.DefaultView.RowFilter = "";

            else if (ColumnName == "PersonID")
                _dtPeople.DefaultView.RowFilter = string.Format("[{0}] ={1}", ColumnName, LbFilter.Text.Trim());
            else
                _dtPeople.DefaultView.RowFilter = string.Format("[{0}] Like '{1}%'", ColumnName, LbFilter.Text.Trim());
        ...
        private void cbFilterBy_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            LbFilter.Visible = (cbFilterBy.Text != "None");
